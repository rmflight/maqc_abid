...
affyDat <- ReadAffy(filenames=fileNames, celfile.path=affyDir, phenoData=pDat)
arrayQualityMetrics(expressionset=affyDat, outdir="affyQuality", do.logtransform=T, force=T)
```
