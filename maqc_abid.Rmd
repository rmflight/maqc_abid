...
they map to multiple locations, then we should remove it from further analysis. For Affy(r), this means that there should
be no more than 1KB range for all the locations reported for the probeset, and for Agilent, there should be only one alignment
reported.
